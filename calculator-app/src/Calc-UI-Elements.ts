...
import { Calculator, isButtonEnabled } from './calculator';
...
test("The 1 button should be enabled", async () => {
    expect(await isButtonEnabled("#btn-1", calculator.getCurrentValue())).toBeTruthy();
  });

test("The 2 button should be enabled", () => {
  expect(isButtonEnabled("#btn-2", calculator.getCurrentValue())).toBeTruthy();
});

test("The 3 button should be enabled", () => {
  expect(isButtonEnabled("#btn-3", calculator.getCurrentValue())).toBeTruthy();
});

test("The 4 button should be enabled", () => {
  expect(isButtonEnabled("#btn-4", calculator.getCurrentValue())).toBeTruthy();
});

test("The 5 button should be enabled", () => {
  expect(isButtonEnabled("#btn-5", calculator.getCurrentValue())).toBeTruthy();
});

test("The 6 button should be enabled", () => {
  expect(isButtonEnabled("#btn-6", calculator.getCurrentValue())).toBeTruthy();
});

test("The 7 button should be enabled", () => {
  expect(isButtonEnabled("#btn-7", calculator.getCurrentValue())).toBeTruthy();
});

test("The 8 button should be enabled", () => {
  expect(isButtonEnabled("#btn-8", calculator.getCurrentValue())).toBeTruthy();
});

test("The 9 button should be enabled", () => {
  expect(isButtonEnabled("#btn-9", calculator.getCurrentValue())).toBeTruthy();
});

test("The 0 button should be enabled", () => {
  expect(isButtonEnabled("#btn-0", calculator.getCurrentValue())).toBeTruthy();
});

test("The addition button should be enabled", () => {
  expect(isButtonEnabled("#btn-add", calculator.getCurrentValue())).toBeTruthy();
});

test("The subtraction button should be enabled", () => {
  expect(isButtonEnabled("#btn-subtract", calculator.getCurrentValue())).toBeTruthy();
});

test("The multiplication button should be enabled", () => {
  expect(isButtonEnabled("#btn-multiply", calculator.getCurrentValue())).toBeTruthy();
});

test("The division button should be enabled", () => {
  expect(isButtonEnabled("#btn-divide", calculator.getCurrentValue())).toBeTruthy();
});

test("The clear button should be enabled", () => {
  expect(isButtonEnabled("#btn-clear", calculator.getCurrentValue())).toBeTruthy();
});

test("The equal button should be enabled", () => {
  expect(isButtonEnabled("#btn-equal", calculator.getCurrentValue())).toBeTruthy();
});
